...
#set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { sda }]; #IO_L21N_T3_DQS_A18_15 Sch=ja[2]
...
#set_property -dict { PACKAGE_PIN H4    IOSTANDARD LVCMOS33 } [get_ports { pwm_o }]; #IO_L21N_T3_DQS_35 Sch=jd[1]
