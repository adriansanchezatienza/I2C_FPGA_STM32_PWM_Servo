...
HD_PWD='C:/Users/adria/Desktop/SED/I2C_SERVO/i2c_servo_basys3/i2c_servo_basys3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log I2C_servo_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source I2C_servo_top.tcl
