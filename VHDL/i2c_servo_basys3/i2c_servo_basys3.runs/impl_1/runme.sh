...
HD_PWD='C:/Users/adria/Desktop/SED/I2C_SERVO/i2c_servo_basys3/i2c_servo_basys3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log I2C_servo_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source I2C_servo_top.tcl -notrace
